...
# New AI extraction settings
AI_CONFIG = config_module.AI_CONFIG
CONTRACT_DEFAULTS = config_module.CONTRACT_DEFAULTS
CONFIDENCE_THRESHOLDS = config_module.CONFIDENCE_THRESHOLDS
QA_CONFIG = config_module.QA_CONFIG
CACHE_CONFIG = config_module.CACHE_CONFIG
CACHE_COMPONENTS = config_module.CACHE_COMPONENTS
...
__all__ = [
    ...
    # New AI settings
    'AI_CONFIG', 'CONTRACT_DEFAULTS', 'CONFIDENCE_THRESHOLDS',
    'QA_CONFIG', 'CACHE_CONFIG', 'CACHE_COMPONENTS',
    'FALLBACK_CONFIG', 'OUTPUT_CONFIG', 'LOGGING_CONFIG'
]
